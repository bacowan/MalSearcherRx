    ...
    override fun getMatchingAnime(searchString: String): Observable<List<Anime>> {
        return Observable.create { emitter ->
            ...
            emitter.onNext(listOf(
                    Anime("Original Pokemon", "https://cdn.ndtv.com/tech/images/gadgets/pikachu_hi_pokemon.jpg?output-quality=70&output-format=webp"),
                    Anime("New Pokemon", "https://cdn.bulbagarden.net/upload/b/b9/172Pichu.png")
            ))
        }
    }
}